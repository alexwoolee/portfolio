    ...
    <div id="about-content">
      <div id="about-top">
        ...
        <div>
          ...
          <h2 id="profession">Software Developer / Anime Connoisseur</h2>
          <ul id="socials">
      ...
      <p id="about-bio">
        ...
        <br/><br/>
        A little about me, I was born in April 2005 in Canada, with a Taiwanese, Korean background. I can speak English, Chinese, and I’m currently learning Japanese at the N5 level. In my free time, I like to develop fun side projects through the power of code, draw, cook different recipes, watch anime, play sports, and listen to music. My favorite genres in music are VGM, JPOP, KPOP, and jazz. 
        <br/><br/>
